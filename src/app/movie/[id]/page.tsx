          ...
          <div className="mt-4">
            <Link href={`/movie/${movie.id}`}>
              <button
                ...
                className="bg-red-600 text-white px-4 py-1 rounded-lg text-md  font-semibold hover:bg-red-700"
              >
                Үзэх
              </button>
            </Link>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="relative w-3/4 h-3/4">
            <iframe
              width={"100%"}
              height={"100%"}
              src={`https://www.youtube.com/embed/8Bkq6CLTO-s?si=ITHWBZvszt9VwYOR`}
              title={movie.title}
              allowFullScreen
